...
def pre_graph_dict(args):
    ...
    lap_dict = {}
    node_dict = {}
    node_dict['PEMS08'], node_dict['PEMS07'], node_dict['PEMS04'], node_dict['CHI_Theft'], node_dict['NYC_Theft'] = 170, 883, 307, 1246, 2256
    for data_graph in args.dataset_graph:
        ...
        elif data_graph in ['CHI_Theft', 'CHI_Assault']:
            Path = os.path.join('../data/CHI_Theft/Adj_CHI_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['NYC_Theft', 'NYC_Assault']:
            Path = os.path.join('../data/NYC_Theft/Adj_NYC_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['DET_Theft', 'DET_Assault']:
            Path = os.path.join('../data/DET_Theft/Adj_DET_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['PHI_Theft', 'PHI_Assault']:
            Path = os.path.join('../data/PHI_Theft/Adj_PHI_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['BOS_Theft', 'BOS_Assault']:
            Path = os.path.join('../data/BOS_Theft/Adj_Boston_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['LOS_Theft', 'LOS_Assault']:
            Path = os.path.join('../data/LOS_Theft/Adj_Los Angeles_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        elif data_graph in ['NEW_Theft', 'NEW_Assault']:
            Path = os.path.join('../data/NEW_Theft/Adj_New Orleans_2016_2017.pkl')
            with open(Path, 'rb') as file:
                A = pickle.load(file)
        else:
